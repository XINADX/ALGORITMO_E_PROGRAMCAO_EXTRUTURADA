...
// Função para listar placas que começam com a letra J e terminam com 0, 2, 4 ou 7, e seus proprietários
...
// Função para listar modelo e cor dos veículos com placas que têm como segunda letra uma vogal e a soma dos valores numéricos é par
